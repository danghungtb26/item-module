...
exports["default"] = {
    up: (_queryInterface, _sequelize) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        statuses.forEach((element) => __awaiter(void 0, void 0, void 0, function* () {
            yield models_1.ItemStatus.create({ name: element });
        }));
    }),
    down: (queryInterface, _sequelize) => __awaiter(void 0, void 0, void 0, function* () {
        yield queryInterface.bulkDelete('ItemStatuses', {});
    }),
};
...
/******/ 	var __webpack_exports__ = __webpack_require__(14209);
/******/ 	
